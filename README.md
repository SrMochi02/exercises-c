#aprendizaje Disciplinado de C - SrMochi02

Este repositorio ha sido creado con el fin de aprender de manera disciplinada
y ordenada el lenguaje C, enfocandome en la logica de bajo nivel, gestion de memoria y
arquitectura de sistemas.

##Objetivos:
* Dominar el uso de punteros y direcciones de memoria.
* Mantener una estructura de archivos limpia y modular.
